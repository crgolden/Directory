...
try
{
    ...
    string experienceClientId, experienceClientSecret;
    ...
    else
    {
        ...
        var secrets = builder.Configuration.GetExperienceSecrets();
        experienceClientId = secrets.ExperienceClientId;
        experienceClientSecret = secrets.ExperienceClientSecret;
        builder.Services
            .AddSerilog((serviceProvider, loggerConfiguration) => loggerConfiguration
                .ReadFrom.Configuration(builder.Configuration)
                .ReadFrom.Services(serviceProvider))
    ...
    builder.Services
        ...
        .ConfigureOpenIdConnect(options =>
        {
            ...
            options.ClientId = experienceClientId;
            options.ClientSecret = experienceClientSecret;
